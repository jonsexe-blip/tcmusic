...
import type { FilterState, Genre, GenreMood, Neighborhood, AgeRestriction, Venue } from "@/lib/types"
...
const genres: Genre[] = [
  ...
  "pop", "soul", "blues", "classical", "comedy", "sports"
]
          ...
          {venues.length > 0 && (
            <section>
              ...
              <input
                ...
                className="w-full mb-3 px-3 py-2 text-sm bg-secondary border border-border rounded-md placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground"
              />
                ...
                {filteredVenues.map((venue) => (
                  <button
                    ...
                    className={cn(
                      ...
                      localFilters.venues.includes(venue.id)
                        ? "bg-foreground text-background border-foreground"
